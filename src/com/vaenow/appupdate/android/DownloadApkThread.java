...
public class DownloadApkThread implements Runnable {
 ...
 //   private AlertDialog mDownloadDialog;
    ...
    public DownloadApkThread(Context mContext, Handler mHandler, String apkUrl,String apkName, CallbackContext callbackContext) {
        //   this.mDownloadDialog = mDownloadDialog;
        this.apkUrl = apkUrl;
      ...
      //  this.authentication = new AuthenticationOptions(options);
        ...
        this.mSavePath = Environment.getExternalStorageDirectory() + "/" + "download"; // SD Path
        this.downloadHandler = new DownloadHandler(mContext,this.mSavePath,apkName,callbackContext);
        //this.downloadHandler = new DownloadHandler(mContext, mProgress, mDownloadDialog, this.mSavePath, mHashMap);
    }
    ...
    private void downloadAndInstall() {
        ...
        try {
            ...
            if (Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED)) {
                // 获得存储卡的路径
                DebugLog.i("wang","apk==before=="+apkUrl);
                if(!apkUrl.startsWith("http")){
                   apkUrl="http://"+apkUrl;
                }
                DebugLog.i("wang","apk===="+apkUrl);
               ...
               // conn.setDoOutput(true);
                ...
                if(conn.getResponseCode()== HttpURLConnection.HTTP_OK){
                    ...
                    do {
                        ...
                        if (numread <= 0) {
                            // 下载完成
                            DebugLog.i("wang","===numread==="+numread);
                    ...
                    Log.i("wang","==code==="+conn.getResponseCode());
                }
            ...
            e.printStackTrace();
            mHandler.obtainMessage(Constants.DOWNLOAD_FAILTURE,e.toString()).sendToTarget();
        } catch (IOException e) {
            e.printStackTrace();
            mHandler.obtainMessage(Constants.DOWNLOAD_FAILTURE,e.toString()).sendToTarget();
        }finally {
